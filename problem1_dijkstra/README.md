...
Run this --> python3 problem1_dijkstra.py
...
1.3 The program runs Dijkstra's algorithm, printing a step-by-step table showing which location is finalized at each stage, then prints the final shortest path and total distance.
...
3.4 The program runs Dijkstra's algorithm, printing a step-by-step table showing which location is finalized at each stage, then prints the final shortest path and total distance.
